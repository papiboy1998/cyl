    ...
    <div class="container">
        <div class="row">
            <div class="divbox wow fadeInUp" data-wow-delay="450ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInUp;">
                <h1>MCA Lead Generation</h1>
			    <p>Cashyew has the most stringent lead qualification process in the MCA Lead Geneartion Industry.All of our leads are phone qualifed by experienced lead qualifiers, who ask up to 20 questions to qualify a lead. The questions are centered around three categories.</p>
                <ul class="points">
                <li><div class="lists">01</div>
                <div class="text"><h4>Minimum Requirements </h4>			   
                    1 year in business, 10K in monthly revenue, 500 or greater Fico credit score, no unresolved bankruptcy, business bank account, positive daily and monthly balances.	</div></li>
                    <li><div class="lists">02</div>
                <div class="text"><h4>Intent </h4>			   
                    Our qualifiers ensure you receive leads where the merchant is in the market for funding. This starts with asking a series  of questions to determine the merchant's true intent.</div></li>
                    <li><div class="lists">03</div>
                <div class="text"><h4>Expectations </h4>			   
                    Our qualifiers set the expectations with each merchant. The merchant will be prepared to fill out a one page application and submit 4 months of his most recent bank statements.</div></li>
                </ul>
		   </div>
        </div>
    </div>
