...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!--====== FAVICON ICON =======-->
        <link href="<?php echo e(asset('images/favicon.png')); ?>" rel="shortcut icon" type="image/ico">

        <!--====== STYLESHEETS ======-->
        <link rel="stylesheet" href="<?php echo e(asset('az/style.css')); ?>">
    ...
    <body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            ...
            <div class="preloader-img">
                <img src="<?php echo e(asset('az/img/core-img/leaf.png')); ?>" alt="">
            </div>
        </div>
                ...
                <div class="classy-nav-container breakpoint-off">
                    <div class="container">
                        ...
                        <nav class="classy-navbar justify-content-between" id="alazeaNav">
                            <!-- Nav Brand -->
                            <a href="index.html" class="nav-brand"><img src="<?php echo e(asset('images/small_h_logo.png')); ?>" alt=""></a>
                            <!-- Navbar Toggler -->
        ...
        <!-- jQuery-2.2.4 js -->
        <script src="<?php echo e(asset('az/js/jquery/jquery-2.2.4.min.js')); ?>"></script>
        <!-- Popper js -->
        <script src="<?php echo e(asset('az/js/bootstrap/popper.min.js')); ?>"></script>
        <!-- Bootstrap js -->
        <script src="<?php echo e(asset('az/js/bootstrap/bootstrap.min.js')); ?>"></script>
        <!-- All Plugins js -->
        <script src="<?php echo e(asset('az/js/plugins/plugins.js')); ?>"></script>
        <!-- Active js -->
        <script src="<?php echo e(asset('az/js/active.js')); ?>"></script>
